...
namespace DrumBuddy.IO.Migrations
{
    ...
    [Migration("20251112070805_RemoveLastSyncedAtFromDb")]
    partial class RemoveLastSyncedAtFromDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrumBuddy.IO.Models.ConfigurationRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DrumBuddy.IO.Models.ConfigurationRecord", b =>
                {
                    b.HasOne("DrumBuddy.IO.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("DrumBuddy.IO.Models.ConfigurationRecord", "UserId")
