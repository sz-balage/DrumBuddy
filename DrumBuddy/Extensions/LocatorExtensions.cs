...
public static class LocatorExtensions
{
    public static T GetRequiredService<T>(this IReadonlyDependencyResolver provider)
    {
        ...
        if (service is null)
        {
            throw new Exception($"Service of type {typeof(T).FullName} could not be resolved.");
        }
        return service;
    }
    public static object GetRequiredService(this IReadonlyDependencyResolver provider, Type serviceType)
    {
        ...
        if (service is null)
        {
            throw new Exception($"Service of type {serviceType.FullName} could not be resolved.");
        }
        return service;
    }
}